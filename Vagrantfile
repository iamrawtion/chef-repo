...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "roshansandbox1"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/roshan4074"
  #   chef.validation_client_name = "roshan4074-validator"
  #   chef.validation_key_path = ".chef/roshan4074-validator.pem"
  # end
end
